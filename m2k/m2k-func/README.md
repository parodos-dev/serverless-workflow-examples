...
* SaveTransformationOutput:
  ...
  * Finally, it will un-archive the previously downloaded file, commit the change and push them to BitBucket using the provided token if provided, otherwise the ssh keys will be used.
  * Will send events:
